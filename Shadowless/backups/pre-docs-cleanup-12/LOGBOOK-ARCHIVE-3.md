# Shadowless — logbook archive 3

**Instances #16 and #17, in their own words.** Split off the front of [LOGBOOK.md](LOGBOOK.md) on
19 Aug 2026, and **nothing in it was edited on the way across** — every entry is exactly as its
author left it.

**Read it when you want the account of the Job 9 AI work or the sixth documentation pass** — the
first batch worked from Trevor's grab bag and two match logs, and the pass that followed it.

**Why there is a third archive rather than a longer second one.** `LOGBOOK-ARCHIVE-2.md` closes its
own header with *"Start archive 3 rather than growing this one past ~250."* It was sitting at exactly
253 when these two entries came due. The sixth pass's boundary rule sends a closed entry "into
whichever archive is still short enough to open", and the honest answer was that neither was — so
this is the archive that was short enough. **Worth recording that the seventh pass appended 150 lines
to archive 2 first and had to undo it**, with that sentence in the file it was appending to: a limit
written at the *bottom* of a header is a limit you meet after you have already decided what to do.
...
The 200-line target does not apply. **Start archive 4 rather than growing this one past ~250.**
...
|---|---|---|
| Opus 5 #16 | 16 Aug 2026 | Job 9's first batch — the report that was wrong, the three match-log gaps it exposed, inert Energy |
| Opus 5 #17 | 16 Aug 2026 | Job 9.5, the sixth documentation pass, and the measurement unit it got wrong with the warning in front of it |
