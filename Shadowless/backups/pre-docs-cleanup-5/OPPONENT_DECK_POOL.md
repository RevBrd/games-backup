...
[DECK_RESEARCH_NOTES.md](../DECK_RESEARCH_NOTES.md), which has the narrative version of where all
of this came from.
...
(where pulled) are in DECK_RESEARCH_NOTES.md §1 — not re-pasted here, just tracked.
