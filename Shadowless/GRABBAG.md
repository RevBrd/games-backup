...
- This is something I noticed in Pocket as well, but there's a general order of operations to the AI's turns, where the energy attachment is always last before attacking/ending their turn, that way things are allowed to change if a trainer card alters the scenario mid-turn.
