...
| **Opus 5** #19 | 18 Aug 2026 — | **Job 10c**: triggered Powers — ON_PLAY, ON_KO and ON_OPP_RETREAT, with `enterPlay` as the one doorway that knows a card came from hand. Five cards, ten printings. Three rulings, two of them pointing their defaults in opposite directions on purpose. Also the coverage gate, which had been blind to Energy since Base Set |
