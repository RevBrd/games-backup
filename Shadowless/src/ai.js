...
class AI {
  ...
  attachValue(pi, slot, energyId) {
    ...
    if (!evo && beforeShort === 0 && afterR.destShort < beforeR.destShort) {
      beforeShort = beforeR.destShort;
      afterShort = afterR.destShort;
      roadGoal = beforeR.destGoal;
    }
  ...
  scoreAction(pi, a) {
    ...
    switch (a.t) {
      ...
      case 'attachEnergy': {
        ...
        // names as walls.
        const charging = after.destShort < before.destShort
