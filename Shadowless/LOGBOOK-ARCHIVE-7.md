# Shadowless — logbook archive 7: Job 15a and Job 15b

**#33, verbatim — both entries.** Job 15a (the Challenge 1 bracket, the first ladder rung belonging
to no set) and Job 15b (the pack odds, and the all-Fire deck holding 24 Fighting Energy that could
not attack). Moved here on 2 Sep 2026 by Shadowless 35 at the end of Job 15d, when the live file had
reached 296 lines against the ~250 rule in its own header **before** this session had appended
anything.
...
**Start `LOGBOOK-ARCHIVE-8.md` rather than growing this one past ~450.** An archive's limit is larger
